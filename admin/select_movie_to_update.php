...
<div class="wrapper">
    ...
    <table>
        ...
        <tr>
            ...
            <td><h4><a href="update_movies.php?id=<?php echo $movie['movie_id']; ?>"><?php echo $movie['movie_name']; ?></h4></a></td> 
        </tr>
        <?php
        }
    } else {
    ...
    <table>
        <?php
        $qry2 = mysqli_query($conn, "SELECT movie_id, movie_name FROM movie");
